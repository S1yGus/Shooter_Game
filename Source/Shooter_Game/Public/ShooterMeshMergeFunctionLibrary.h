...
#include "ShooterMeshMergeFunctionLibrary.generated.h"
/**
...
struct SHOOTER_GAME_API FSkelMeshMergeSectionMapping_BP
{
    GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct SHOOTER_GAME_API FSkelMeshMergeUVTransform
{
    GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct SHOOTER_GAME_API FSkelMeshMergeUVTransformMapping
{
    GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct SHOOTER_GAME_API FSkeletalMeshMergeParams
{
    GENERATED_BODY()
 ...
 */
UCLASS()
class SHOOTER_GAME_API UShooterMeshMergeFunctionLibrary : public UBlueprintFunctionLibrary
{
    GENERATED_BODY()
public:
    /**
